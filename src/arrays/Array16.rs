...
#[repr(C, packed)]
pub struct Array16<T>(pub [T; 16]);

impl<T> Array<T> for Array16<T>
{
	const Size: usize = 16;
	const Mask: usize = 16 - 1;
...
impl<T: Copy> Copy for Array16<T>
{
}

impl<T: Copy> Clone for Array16<T>
{
	#[inline(always)]
	fn clone(&self) -> Self
	{
...
impl<T: Debug> Debug for Array16<T>
{
	#[inline(always)]
...
impl<T: PartialEq> PartialEq for Array16<T>
{
	#[inline(always)]
	fn eq(&self, other: &Array16<T>) -> bool
	{
		self.0[..].eq(&other.0[..])
	}
}

impl<T: Eq> Eq for Array16<T>
{
}

impl<T: PartialOrd> PartialOrd for Array16<T>
{
	#[inline(always)]
	fn partial_cmp(&self, other: &Array16<T>) -> Option<Ordering>
	{
		PartialOrd::partial_cmp(&&self.0[..], &&other.0[..])
	}

	#[inline(always)]
	fn lt(&self, other: &Array16<T>) -> bool
	{
		PartialOrd::lt(&&self.0[..], &&other.0[..])
	}

	#[inline(always)]
	fn le(&self, other: &Array16<T>) -> bool
	{
		PartialOrd::le(&&self.0[..], &&other.0[..])
	}

	#[inline(always)]
	fn ge(&self, other: &Array16<T>) -> bool
	{
		PartialOrd::ge(&&self.0[..], &&other.0[..])
	}

	#[inline(always)]
	fn gt(&self, other: &Array16<T>) -> bool
	{
		PartialOrd::gt(&&self.0[..], &&other.0[..])
	}
}

impl<T: Ord> Ord for Array16<T>
{
	#[inline(always)]
	fn cmp(&self, other: &Array16<T>) -> Ordering
	{
		Ord::cmp(&&self.0[..], &&other.0[..])
	}
}

impl<T: Hash> Hash for Array16<T>
{
	#[inline(always)]
...
impl<'a, T> IntoIterator for &'a Array16<T>
{
	type Item = &'a T;
...
impl<'a, T> IntoIterator for &'a mut Array16<T>
{
	type Item = &'a mut T;
